 ...
 */
import {
    FIND_TOPIC_FOR_PAGE_FETCH,
    FIND_TOPIC_FOR_PAGE_SUCCESS,
    FIND_TOPIC_FOR_PAGE_ERROR,
    FIND_MORE_TOPIC_FOR_PAGE_SUCCESS,
    FIND_MORE_TOPIC_FOR_PAGE_FETCH
} from './actionTypes';
...
export default (state = {}, action) => {
    switch (action.type) {
        ...
        case FIND_TOPIC_FOR_PAGE_SUCCESS: {
            return {
                type: FIND_TOPIC_FOR_PAGE_SUCCESS, data: action.data, params: action.params, isLoadingList: false
            }
        }
        ...
        case FIND_MORE_TOPIC_FOR_PAGE_FETCH: {
            return {
        ...
        case FIND_MORE_TOPIC_FOR_PAGE_SUCCESS: {
            ...
            return {
                type: FIND_TOPIC_FOR_PAGE_SUCCESS, data: action.data, params: action.params, isLoadingMore: false
            }
        }
